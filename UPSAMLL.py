...
import math
import os
from PIL import Image, ImageOps, ImageFile, ImageDraw, ImageFont, ImageEnhance,ImageFilter
import numpy as np
import cv2 as cv
...
class pixworker(QThread):
    ...
    def __init__(self,  index=0):
        ...
        self.is_running = True
    def rembgdef(self,file_fath):
        input = Image.open(file_fath)
        img = remove(input)
        if img.mode != 'RGBA':
    ...
    def save(self, num, final_list):
        ...
        if 'e' in num:
            ...
            li = doubleagent.whiterbg(final_list[0])
            randomi = random.randrange(60, 100)
            li.save('small//e'+str(num)+'.jpg', 'JPEG', quality=randomi)
            li = doubleagent.whiterbg(final_list[1])
            # randomi = random.randrange(60, 100)
            # li.save('small//b'+str(num)+'.jpg', 'JPEG', quality=randomi)
            li = doubleagent.whiterbg(final_list[2])
            randomi = random.randrange(60, 100)
            li.save('small//e'+str(num)+'-2.jpg', 'JPEG', quality=randomi)
            li = doubleagent.whiterbg(final_list[3])
            # randomi = random.randrange(60, 100)
            # li.save('small//b'+str(num)+'-2.jpg', 'JPEG', quality=randomi)
            li = doubleagent.whiterbg(final_list[4])
            randomi = random.randrange(60, 100)
            li.save('small//e'+str(num)+'-3.jpg', 'JPEG', quality=randomi)
            li = doubleagent.whiterbg(final_list[5])
            # randomi = random.randrange(60, 100)
            # li.save('small//b'+str(num)+'-3.jpg', 'JPEG', quality=randomi)
            ...
            li = doubleagent.whiterbg(final_list[0])
            randomi = random.randrange(60, 100)
            li.save('big//e'+str(num)+'.jpg', 'JPEG', quality=randomi)
            li = doubleagent.whiterbg(final_list[1])
            # randomi = random.randrange(60, 100)
            # li.save('big//b'+str(num)+'.jpg', 'JPEG', quality=randomi)
            li = doubleagent.whiterbg(final_list[2])
            randomi = random.randrange(60, 100)
            li.save('big//e'+str(num)+'-2.jpg', 'JPEG', quality=randomi)
            li = doubleagent.whiterbg(final_list[3])
            # randomi = random.randrange(60, 100)
            # li.save('big//b'+str(num)+'-2.jpg', 'JPEG', quality=randomi)
            li = doubleagent.whiterbg(final_list[4])
            randomi = random.randrange(60, 100)
            li.save('big//e'+str(num)+'-3.jpg', 'JPEG', quality=randomi)
            li = doubleagent.whiterbg(final_list[5])
            # randomi = random.randrange(60, 100)
            # li.save('big//b'+str(num)+'-3.jpg', 'JPEG', quality=randomi)
        if 'f' in num:
            ...
            li = doubleagent.whiterbg(final_list[0])
            randomi = random.randrange(60, 100)
            li.save('small//f'+str(num)+'.jpg', 'JPEG', quality=randomi)
            li = doubleagent.whiterbg(final_list[1])
            # randomi = random.randrange(60, 100)
            # li.save('small//b'+str(num)+'.jpg', 'JPEG', quality=randomi)
            li = doubleagent.whiterbg(final_list[2])
            randomi = random.randrange(60, 100)
            li.save('small//f'+str(num)+'-2.jpg', 'JPEG', quality=randomi)
            li = doubleagent.whiterbg(final_list[3])
            # randomi = random.randrange(60, 100)
            # li.save('small//b'+str(num)+'-2.jpg', 'JPEG', quality=randomi)
            li = doubleagent.whiterbg(final_list[4])
            randomi = random.randrange(60, 100)
            li.save('small//f'+str(num)+'-3.jpg', 'JPEG', quality=randomi)
            li = doubleagent.whiterbg(final_list[5])
            # randomi = random.randrange(60, 100)
            # li.save('small//b'+str(num)+'-3.jpg', 'JPEG', quality=randomi)
            ...
            li = doubleagent.whiterbg(final_list[0])
            randomi = random.randrange(60, 100)
            li.save('big//f'+str(num)+'.jpg', 'JPEG', quality=randomi)
            li = doubleagent.whiterbg(final_list[1])
            # randomi = random.randrange(60, 100)
            # li.save('big//b'+str(num)+'.jpg', 'JPEG', quality=randomi)
            li = doubleagent.whiterbg(final_list[2])
            randomi = random.randrange(60, 100)
            li.save('big//f'+str(num)+'-2.jpg', 'JPEG', quality=randomi)
            li = doubleagent.whiterbg(final_list[3])
            # randomi = random.randrange(60, 100)
            # li.save('big//b'+str(num)+'-2.jpg', 'JPEG', quality=randomi)
            li = doubleagent.whiterbg(final_list[4])
            randomi = random.randrange(60, 100)
            li.save('big//f'+str(num)+'-3.jpg', 'JPEG', quality=randomi)
            li = doubleagent.whiterbg(final_list[5])
            # randomi = random.randrange(60, 100)
            # li.save('big//b'+str(num)+'-3.jpg', 'JPEG', quality=randomi)
    ...
    def color_saturation(self,img):

        if img.mode != 'RGBA':
            raise ValueError("이미지는 RGBA 모드여야 합니다.")
        
        factor = round(random.uniform(3, 5), 2)
        enhancer = ImageEnhance.Color(img)
        img_adjusted = enhancer.enhance(factor)
        
        return img_adjusted

    def add_stroke(self,img, size=20, pos=(0,0)):
    ...
    def splitim(self, solo):
        ...
        if y > x:
            ...
            result3 = doubleagent.alpacomposite(background, result3, ((
                round(10+(650-(llx-lx))/2), round(260+(650-(lly-ly))/2))))
# 이미지 처리 핵심 로직
            result1 = self.color_saturation(result1)
            result2 = self.color_saturation(result2)
            result3 = self.color_saturation(result3)
            result1 =self.add_stroke(result1)
            result2 =self.add_stroke(result2)
            result3 =self.add_stroke(result3)
            result3.show()
